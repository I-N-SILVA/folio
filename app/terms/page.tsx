...
export const metadata: Metadata = {
  ...
  description: 'The terms that govern your use of KLICKO.',
}
  ...
  return (
    <LegalShell title="Terms of Service" updated="June 12, 2026">
      <p className="text-[15px] leading-7 text-[var(--folio-muted)]">
        These Terms of Service (&ldquo;Terms&rdquo;) govern your access to and use of KLICKO (the
      ...
      <LegalSection heading="Disclaimers & liability">
        <p>
          ...
          extent permitted by law, KLICKO is not liable for indirect, incidental, or consequential
      ...
      <LegalSection heading="Contact">
        <p>
          Questions about these Terms? Email <strong>legal@klicko.app</strong>.
        </p>
      </LegalSection>
    </LegalShell>
  )
