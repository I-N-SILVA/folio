// ─── Folio plan catalog & entitlements ──────────────────────────────────────
//
...
export type Entitlements = {
  ...
  /** Whether the public reader shows the "Made with Folio" watermark. */
  watermark: boolean
  ...
  csvExport: boolean
  /** Remove Folio branding entirely (white-label). */
  whiteLabel: boolean
}
...
/** Maps an AppSumo purchase tier (1-based) to a Folio plan id. */
