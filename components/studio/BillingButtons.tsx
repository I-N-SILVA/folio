...
export function UpgradeButton({ className = '' }: { className?: string }) {
  ...
  return (
    <button
      ...
      disabled={loading}
      className={`inline-flex items-center justify-center gap-2 rounded-full bg-[var(--folio-teal)] px-5 py-3 text-sm font-semibold uppercase tracking-[0.14em] text-white transition hover:-translate-y-0.5 hover:bg-[#0a5be0] disabled:opacity-50 ${className}`}
    >
