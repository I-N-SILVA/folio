  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <Link
        ...
        scroll={false}
        className="flex items-center gap-2 rounded-full bg-[var(--accent)] px-5 py-3 text-sm font-semibold uppercase tracking-[0.14em] text-[var(--accent-contrast)] shadow-md transition hover:-translate-y-0.5 hover:bg-[var(--accent-hover)]"
      >
        <Plus size={16} />
        Create New
      </Link>
