...
export function ClosingCta() {
  return (
    <section className="px-5 py-28">
      <div className="mx-auto max-w-4xl overflow-hidden rounded-[2rem] bg-[var(--invert-surface)] px-8 py-20 text-center text-[var(--invert-text)]">
        <Reveal>
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Link href="/login" className="w-full rounded-full bg-[var(--qlico-paper)] px-7 py-3.5 text-[15px] font-semibold text-[var(--qlico-ink)] transition hover:bg-[var(--qlico-paper)]/90 sm:w-auto">
              Start for free
            </Link>
