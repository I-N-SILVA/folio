  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-4 left-4 w-8 h-8 rounded-full bg-black/60 hover:bg-black/75 text-white text-sm font-medium flex items-center justify-center backdrop-blur-sm transition-colors z-40"
